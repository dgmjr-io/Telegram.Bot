...
public class ColorTests
{
    ...
    public void Should_Create_Int_Color_Instance_With_Correct_Components(
        int color,
        int red,
        int green,
        int blue
    ...
    [InlineData(0xFFFFFF, 255, 255, 255)] // 16777215
    [InlineData(0x0, 0, 0, 0)] // 0
    public void Should_Create_Uint_Color_Instance_With_Correct_Components(
        uint color,
        int red,
        int green,
        int blue
    ...
    public void Should_Create_Int_Color_Instance_From_Components(
        int red,
        int green,
        int blue,
        int color
    ...
    [InlineData(255, 255, 255, 0xFFFFFF)] // 16777215
    [InlineData(0, 0, 0, 0x0)] // 0
    public void Should_Create_Uint_Color_Instance_From_Components(
        uint red,
        uint green,
        uint blue,
        int color
    ...
    public void Should_Throw_On_Incorrect_Int_Color_Component(
        int red,
        int green,
        int blue,
    ...
    [InlineData(256, 255, 255, "red")]
    [InlineData(255, 256, 255, "green")]
    public void Should_Throw_On_Incorrect_Uint_Color_Component(
        uint red,
        uint green,
        uint blue,
        string componentName
    ...
    public void Should_Convert_Int_Color_To_Byte_Array_Representation(
        int color,
        byte[] expectedArray
    )
    {
    ...
    [InlineData(0xFFFFFF, new byte[] { 255, 255, 255, 0 })] // 16777215
    [InlineData(0x0, new byte[] { 0, 0, 0, 0 })] // 0
    public void Should_Convert_Uint_Color_To_Byte_Array_Representation(
        uint color,
        byte[] expectedArray
    )
    {

...
public class ApiExceptionsTests2
{
    ...
    [OrderedFact(
        "Should throw ApiRequestException while asking for user's phone number "
    ...
    public async Task Should_Throw_Exception_ApiRequestException()
    {
        ReplyKeyboardMarkup replyMarkup =
            new(new[] { KeyboardButton.WithRequestContact("Share Contact"), });
    ...
    [OrderedFact(
        "Should throw MessageIsNotModifiedException while editing previously "
